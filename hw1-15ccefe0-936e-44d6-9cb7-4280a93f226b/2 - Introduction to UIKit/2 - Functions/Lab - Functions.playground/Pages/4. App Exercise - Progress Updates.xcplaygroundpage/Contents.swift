...
func progressUpdate(steps: Int, goal: Int) {
    func makeDescription(percent: Double) -> String {
        switch percent {
        case ..<10: return "You're off to a good start."
        case ..<50: return "You're almost halfway there!"
        case ..<90: return "You're over halfway there!"
        case ..<100: return "You're almost there!"
        default: return "You beat your goal!"
        }
    }
    
    print(makeDescription(percent: Double(steps) / Double(goal) * 100.0))
}

progressUpdate(steps: 1, goal: 100)
progressUpdate(steps: 14, goal: 100)
progressUpdate(steps: 45, goal: 100)
progressUpdate(steps: 68, goal: 100)
progressUpdate(steps: 97, goal: 100)
progressUpdate(steps: 180, goal: 100)
...
func pacing(
    ...
    let distanceFraction = currentDistance / totalDistance
    let timeFraction = currentTime / goalTime
