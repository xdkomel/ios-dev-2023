...
let favoriteBook = Book(title: "Das Kapital", author: "Carl Marx", pages: 1392, price: 0)

print("My favourite book is \(favoriteBook.title), written by \(favoriteBook.author), it has \(favoriteBook.pages) pages, and should cost \(favoriteBook.price) rubles")
/*:
...
let myMac = Laptop(screenSize: 16, yearPurchased: 2020)
let workMax = Laptop(screenSize: 16, repairCount: 1, yearPurchased: 2022)
/*:
