...
let printWorkout: (Double, Double, Double) -> String = {
    return "You ran \($0) meters in \($1) minutes, and gain \($2) meters of elevation"
}

print(printWorkout(firstRun.distance, firstRun.time, firstRun.elevation))
